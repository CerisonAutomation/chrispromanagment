// =============================================================================
// CANONICAL PUCK MEMOIZE-COMPONENT
// Mirror of puck-main/packages/core/components/MemoizeComponent/index.tsx
...
/**
 * Renders the Component and only re-renders when its props change using shallow comparison.
 * Uses deep comparison for the "puck" prop.
 */
