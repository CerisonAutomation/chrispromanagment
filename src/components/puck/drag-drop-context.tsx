// =============================================================================
// CANONICAL PUCK DRAG-DROP-CONTEXT COMPONENT
// Mirror of puck-main/packages/core/components/DragDropContext/index.tsx
// Shared DND context with custom sensors
// =============================================================================
...
import {DropZoneProvider} from "./drop-zone-provider";
import {getItem} from "../../lib/utils/data/get-item";
import {DropZoneContext, Preview, RootVirtualizerHandle, ZoneStore, ZoneStoreProvider,} from "./drop-zone-context";
...
import {ComponentDndData} from "./draggable-component";
