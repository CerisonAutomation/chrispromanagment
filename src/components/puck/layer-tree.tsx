// =============================================================================
// CANONICAL PUCK LAYER-TREE COMPONENT
// Mirror of puck-main/packages/core/components/LayerTree/index.tsx
// Visual component hierarchy component
// =============================================================================

import styles from "./styles.module.css";
import getClassNameFactory from "../../lib/get-class-name-factory";
import {Config} from "../../lib/types";
import {ItemSelector} from "../../lib/utils/data/get-item";
import {ChevronDown, Layers, LayoutGrid, Type} from "lucide-react";
import {rootAreaId} from "../../lib/root-droppable-id";
import {ForwardedRef, forwardRef, useCallback, useContext, useRef,} from "react";
import {ZoneStoreContext} from "./drop-zone-context";
import {useAppStore} from "../../store";
import {useContextStore} from "../../lib/use-context-store";
import {NodeIndex, ZoneIndex} from "../../lib/types/Internal";
