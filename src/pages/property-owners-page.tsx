      ...
      <section id="why-us" className="py-16 md:py-24 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20 relative">
          <div className="max-w-3xl">
            <span className="text-xs uppercase tracking-widest text-[#C9A84C] mb-4 block">
              For Property Owners
            </span>
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <div className="bg-[#161618] border border-white/5 p-8 relative">
              ...
              <div className="space-y-6">
                <div>
                  <h4 className="text-[#F5F5F0] font-semibold mb-3 flex items-center gap-2">
                    <TrendingUp className="w-4 h-4 text-[#C9A84C]" /> Listing & Revenue
                  </h4>
                  <ul className="space-y-2 text-sm text-[#A1A1AA]">
                    <li className="flex items-start gap-2"><Check className="w-4 h-4 text-[#C9A84C] flex-shrink-0 mt-0.5" /> Multi-channel listing creation & management</li>
                    <li className="flex items-start gap-2"><Check className="w-4 h-4 text-[#C9A84C] flex-shrink-0 mt-0.5" /> Superhost status from day one</li>
                    <li className="flex items-start gap-2"><Check className="w-4 h-4 text-[#C9A84C] flex-shrink-0 mt-0.5" /> Smart seasonal pricing optimization</li>
                    <li className="flex items-start gap-2"><Check className="w-4 h-4 text-[#C9A84C] flex-shrink-0 mt-0.5" /> Reviews & reputation management</li>
                  </ul>
                </div>
                <div>
                  <h4 className="text-[#F5F5F0] font-semibold mb-3 flex items-center gap-2">
                    <Users className="w-4 h-4 text-[#C9A84C]" /> Operations
                  </h4>
                  <ul className="space-y-2 text-sm text-[#A1A1AA]">
                    <li className="flex items-start gap-2"><Check className="w-4 h-4 text-[#C9A84C] flex-shrink-0 mt-0.5" /> Guest communication & 24/7 concierge</li>
                    <li className="flex items-start gap-2"><Check className="w-4 h-4 text-[#C9A84C] flex-shrink-0 mt-0.5" /> Check-in & check-out coordination</li>
                    <li className="flex items-start gap-2"><Check className="w-4 h-4 text-[#C9A84C] flex-shrink-0 mt-0.5" /> Professional cleaning & laundry</li>
                    <li className="flex items-start gap-2"><Check className="w-4 h-4 text-[#C9A84C] flex-shrink-0 mt-0.5" /> Maintenance coordination — at cost</li>
                    <li className="flex items-start gap-2"><Check className="w-4 h-4 text-[#C9A84C] flex-shrink-0 mt-0.5" /> Payment collection & eco-tax compliance</li>
                  </ul>
                </div>
              ...
              <Button
                onClick={() => openOwnerModal()}
                variant="outline"
                className="w-full mt-8 border-[#C9A84C] text-[#C9A84C] hover:bg-[#C9A84C] hover:text-[#0F0F10] rounded-none uppercase tracking-widest py-4"
              >
                Get Started
              </Button>
            </div>
            ...
            <div className="bg-[#161618] border-2 border-[#C9A84C]/30 p-8 relative">
              <div className="absolute -top-3 left-8 bg-[#C9A84C] text-[#0F0F10] px-4 py-1 text-xs uppercase tracking-widest font-semibold">
                Most Popular
              </div>
              ...
              <div className="space-y-6">
                <div>
                  <h4 className="text-[#F5F5F0] font-semibold mb-3 flex items-center gap-2">
                    <Zap className="w-4 h-4 text-[#C9A84C]" /> Everything in Essentials, plus:
                  </h4>
                  <ul className="space-y-2 text-sm text-[#A1A1AA]">
                    <li className="flex items-start gap-2"><Check className="w-4 h-4 text-[#C9A84C] flex-shrink-0 mt-0.5" /> Welcome amenities — wine, coffee, toiletries included</li>
                    <li className="flex items-start gap-2"><Check className="w-4 h-4 text-[#C9A84C] flex-shrink-0 mt-0.5" /> Guest property manual included</li>
                    <li className="flex items-start gap-2"><Check className="w-4 h-4 text-[#C9A84C] flex-shrink-0 mt-0.5" /> Property assessment & readiness checklist</li>
                  </ul>
                </div>
                <div>
                  <h4 className="text-[#F5F5F0] font-semibold mb-3 flex items-center gap-2">
                    <BadgePercent className="w-4 h-4 text-[#C9A84C]" /> Included Fees (No Extra Charges)
                  </h4>
                  <ul className="space-y-2 text-sm text-[#A1A1AA]">
                    <li className="flex items-start gap-2"><Check className="w-4 h-4 text-[#C9A84C] flex-shrink-0 mt-0.5" /> Monthly reporting included — saves €420/year</li>
                    <li className="flex items-start gap-2"><Check className="w-4 h-4 text-[#C9A84C] flex-shrink-0 mt-0.5" /> All callout fees included — saves €240+/year</li>
                    <li className="flex items-start gap-2"><Check className="w-4 h-4 text-[#C9A84C] flex-shrink-0 mt-0.5" /> Annual photography refresh included — saves ~€300/year</li>
                    <li className="flex items-start gap-2"><Check className="w-4 h-4 text-[#C9A84C] flex-shrink-0 mt-0.5" /> €100 annual platform fee waived</li>
                  </ul>
                </div>
                <div>
                  <h4 className="text-[#F5F5F0] font-semibold mb-3 flex items-center gap-2">
                    <Star className="w-4 h-4 text-[#C9A84C]" /> Strategic Services
                  </h4>
                  <ul className="space-y-2 text-sm text-[#A1A1AA]">
                    <li className="flex items-start gap-2"><Check className="w-4 h-4 text-[#C9A84C] flex-shrink-0 mt-0.5" /> Quarterly performance reviews & optimization</li>
                    <li className="flex items-start gap-2"><Check className="w-4 h-4 text-[#C9A84C] flex-shrink-0 mt-0.5" /> Priority 24-hour owner response time</li>
                    <li className="flex items-start gap-2"><Check className="w-4 h-4 text-[#C9A84C] flex-shrink-0 mt-0.5" /> Dedicated direct booking webpage</li>
                  </ul>
                </div>
              </div>
              ...
              <Button
                onClick={() => openOwnerModal()}
                className="w-full mt-8 bg-[#C9A84C] text-[#0F0F10] hover:bg-[#D4B85C] rounded-none uppercase tracking-widest py-4 btn-gold-glow"
              >
                Get Started
              </Button>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {whyChooseUs.items?.map((item, i) => (
              <div
                key={i}
                className="bg-[#161618] p-8 border border-white/5 hover:border-[#C9A84C]/20 transition-colors"
              >
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {serviceItems.map((service, i) => (
              ...
              >
                <service.icon className="w-8 h-8 text-[#C9A84C] mb-4 group-hover:scale-110 transition-transform" />
        ...
        <div className="max-w-3xl mx-auto px-6 md:px-12 lg:px-20">
          ...
          <Accordion type="single" collapsible className="space-y-4">
            {faqs.map((faq, i) => (
              ...
              >
                <AccordionTrigger className="text-[#F5F5F0] text-left hover:text-[#C9A84C] hover:no-underline py-6">
                  {faq.q}
                </AccordionTrigger>
        ...
        <div className="max-w-4xl mx-auto px-6 md:px-12 lg:px-20 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 border border-white/30 text-[#F5F5F0] hover:border-[#C9A84C] hover:text-[#C9A84C] transition-colors px-8 py-4 uppercase text-sm tracking-widest"
            >
