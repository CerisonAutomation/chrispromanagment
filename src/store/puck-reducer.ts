...
import type {AppState, ComponentData, Data, ItemSelector, RootData, UiState,} from "../types";
...
/** Selector for targeting a specific item */
    ...
    switch (action.type) {
      ...
      case "batch": {
        ...
        for (const subAction of action.actions) {
          newState = createReducer()(newState, subAction);
        }
        return newState;
      }
