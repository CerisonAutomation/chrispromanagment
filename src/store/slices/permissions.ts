// =============================================================================
// CANONICAL PUCK PERMISSIONS SLICE
// Mirror of puck-main/packages/core/store/slices/permissions.ts
// Dynamic permission recalculation
// =============================================================================

import {useEffect} from "react";
import {flattenData} from "../../lib/utils/data-helpers";
import {ComponentData, Config, Permissions, UserGenerics} from "../../lib/types";
import {getChanged} from "../../lib/utils/get-changed";
import {AppStore, useAppStoreApi} from "../index";
import {makeStatePublic} from "../../lib/utils/make-state-public";
