/**
 * @fileoverview Ω⁷ Canonical Puck Schema — 40 unified blocks.
 *
 * Sources:
 *   Puck demo (12): https://github.com/measuredco/puck/tree/main/apps/demo/config
 *   chrispropmanagment (28): https://github.com/CerisonAutomation/chrispropmanagment/tree/main/src/blocks
 */

import { z } from "zod";

// ─── Primitives ────────────────────────────────────────────────────────────────
export const CSSValueSchema = z.string().regex(/^\d+(\.\d+)?(px|rem|em|vh|vw|%|dvh)$/);
...
export const HeroPropsSchema = z.object({
  ...
  })).max(4).default([{ label: "Learn more", href: "#" }]),
  image: z.object({
...
export const PricingTablePropsSchema = z.object({
  ...
  plans: z.array(z.object({
    name: z.string().min(1),
    price: z.object({ monthly: z.number().min(0), annual: z.number().min(0).optional() }),
...
export const TeamSectionPropsSchema = z.object({
  ...
  members: z.array(z.object({
    ...
    image: ImageSchema.optional(),
    socialLinks: z.array(z.object({ platform: z.string(), href: z.string() })).optional().default([]),
...
export const BLOCK_TYPES: PuckBlockType[] = [
  "Button", "Card", "Flex", "Grid", "Heading", "Hero", "Logos", "RichText", "Space", "Stats", "Template", "Text",
  "AboutSection", "BookingSection", "CanonicalBlocks", "ComparisonSection", "ContactSection", "Content",
  "CtaBanner", "Divider", "Elements", "FaqSection", "FeatureGrid", "FooterSection",
  "GuestyBookingConfirmation", "GuestyBookingDashboard", "GuestyBookingWidget",
  "GuestyPropertyDetail", "GuestyPropertyGrid", "GuestyPropertySearch",
  "Helpers", "HeroSection", "ImageGallery", "ImageWithText", "Layout", "LogoBar",
  "MaltaMapSection", "MapSection", "NewsletterSection", "PricingTable", "PropertyShowcase",
  "ServicesSection", "SocialProofStrip", "Spacer", "StatsSection", "TeamSection",
  "TestimonialSection", "TextBlock", "ThemeSettings", "Timeline", "VideoSection", "WhyChooseUs",
];
...
export const CATEGORIES: Record<string, PuckBlockType[]> = {
  ...
  guesty: ["BookingSection", "GuestyBookingConfirmation", "GuestyBookingDashboard", "GuestyBookingWidget", "GuestyPropertyDetail", "GuestyPropertyGrid", "GuestyPropertySearch", "PropertyShowcase"],
  media: ["ImageGallery", "ImageWithText", "VideoSection", "LogoBar", "Logos"],
  other: ["Card", "Template", "AboutSection", "CanonicalBlocks", "ComparisonSection", "ContactSection", "Elements", "FaqSection", "FeatureGrid", "FooterSection", "Helpers", "MaltaMapSection", "MapSection", "PricingTable", "ServicesSection", "SocialProofStrip", "Stats", "StatsSection", "TeamSection", "TestimonialSection", "ThemeSettings", "Timeline", "WhyChooseUs"],
};

export const BLOCK_SCHEMAS: Record<PuckBlockType, z.ZodSchema<unknown>> = {
  Button: ButtonPropsSchema, Card: CardPropsSchema, Flex: FlexPropsSchema, Grid: GridPropsSchema,
  Heading: HeadingPropsSchema, Hero: HeroPropsSchema, Logos: LogosPropsSchema, RichText: RichTextPropsSchema,
  Space: SpacePropsSchema, Stats: StatsPropsSchema, Template: TemplatePropsSchema, Text: TextPropsSchema,
  AboutSection: AboutSectionPropsSchema, BookingSection: BookingSectionPropsSchema, CanonicalBlocks: CanonicalBlocksPropsSchema,
  ComparisonSection: ComparisonSectionPropsSchema, ContactSection: ContactSectionPropsSchema, Content: ContentPropsSchema,
  CtaBanner: CtaBannerPropsSchema, Divider: DividerPropsSchema, Elements: ElementsPropsSchema,
  FaqSection: FaqSectionPropsSchema, FeatureGrid: FeatureGridPropsSchema, FooterSection: FooterSectionPropsSchema,
  GuestyBookingConfirmation: GuestyBookingConfirmationPropsSchema, GuestyBookingDashboard: GuestyBookingDashboardPropsSchema,
  GuestyBookingWidget: GuestyBookingWidgetPropsSchema, GuestyPropertyDetail: GuestyPropertyDetailPropsSchema,
  GuestyPropertyGrid: GuestyPropertyGridPropsSchema, GuestyPropertySearch: GuestyPropertySearchPropsSchema,
  Helpers: HelpersPropsSchema, HeroSection: HeroSectionPropsSchema, ImageGallery: ImageGalleryPropsSchema,
  ImageWithText: ImageWithTextPropsSchema, Layout: LayoutPropsSchema, LogoBar: LogoBarPropsSchema,
  MaltaMapSection: MaltaMapSectionPropsSchema, MapSection: MapSectionPropsSchema,
  NewsletterSection: NewsletterSectionPropsSchema, PricingTable: PricingTablePropsSchema,
  PropertyShowcase: PropertyShowcasePropsSchema, ServicesSection: ServicesSectionPropsSchema,
  SocialProofStrip: SocialProofStripPropsSchema, Spacer: SpacerPropsSchema, StatsSection: StatsSectionPropsSchema,
  TeamSection: TeamSectionPropsSchema, TestimonialSection: TestimonialSectionPropsSchema, TextBlock: TextBlockPropsSchema,
  ThemeSettings: ThemeSettingsPropsSchema, Timeline: TimelinePropsSchema, VideoSection: VideoSectionPropsSchema,
  WhyChooseUs: WhyChooseUsPropsSchema,
};

export const PuckPageDataSchema = z.object({
  content: z.array(z.object({ type: z.string(), props: z.record(z.any()) })),
  root: z.object({ props: z.object({ title: z.string().optional() }) }),
  zones: z.record(z.string(), z.array(z.object({ type: z.string(), props: z.record(z.any()) }))).optional().default({}),
});
